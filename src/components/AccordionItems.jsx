...
const AccordionItems = ({ items, resInfo }) => {
  ...
  return (
    <div>
      {items.map((item) => (
        <div
          className="flex justify-between py-7 px-0 border-b-2 border-gray-300"
        ...
        >
          ...
          <div className="relative h-28">
            <img
              className="w-32 h-24 md:w-36 object-cover rounded-md"
            ...
            {cartItems.some(
              ...
              <div className="inc-dec-count menu-counter absolute bottom-2 left-5 md:left-8 shadow-lg bg-white">
                <div
              ...
              <button
                className="absolute bottom-2 left-8 md:left-10 py-0.5 px-4 shadow-lg rounded-md text-green-600 bg-white border-green-600 font-medium cursor-pointer"
